...
import ru.zagvladimir.tgbot.telegram.internal.format.RateChartRenderer;

@Component
class ChartCommandHandler implements CommandHandler {
    ...
    static int parseDays(String[] parts) {
        if (parts.length < 2) {
            return DEFAULT_DAYS;
        }
