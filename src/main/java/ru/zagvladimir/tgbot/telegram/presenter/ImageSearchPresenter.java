...
import ru.zagvladimir.tgbot.telegram.format.HtmlEscaper;

@Component
public class ImageSearchPresenter {

    public static final String CALLBACK_PREFIX = "img:";
    ...
    public InlineKeyboardMarkup keyboard(String queryId, int index, boolean hasMore) {
    ...
    public static String describe(ImageSearchOutcome outcome) {
    ...
    public static List<String> parseCallback(String data) {
