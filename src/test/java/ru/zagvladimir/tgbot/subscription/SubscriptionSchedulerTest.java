...
class SubscriptionSchedulerTest {
    ...
    void computesNextRunInSubscriptionTimezoneNotServerOne() {
        ...
        var minskRun = SubscriptionService.nextRunAfter("0 0 9 * * *", MINSK, from);
        var tokyoRun = SubscriptionService.nextRunAfter("0 0 9 * * *", tokyo, from);
    ...
    void survivesDaylightSavingTransition() {
        ...
        var next = SubscriptionService.nextRunAfter("0 30 2 * * *", warsaw, beforeSpringForward);
